...
| <img src="assets/icons/code.ico" width="22" height="22" alt="T3 Code icon"> | T3 Code Web | Not deployed | Planned (IngressRoute and EndpointSlice stub exists, LAN backend `.195` pending) | `code.dsns.dev` |
| <img src="assets/icons/wireguard.png" width="22" height="22" alt="WireGuard icon"> | WireGuard VPN | Not deployed | Planned, no manifests yet | Not publicly accessible |

All icons are the official marks served by each project or site. The Minecraft icon is the monitor avatar from the status page.
...
- **Planned work:** Immich and T3 Code Web already have routes and slices, and only their LAN backends are pending. WireGuard has no manifests yet.
